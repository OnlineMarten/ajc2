...
public function getAvailableTickets($ignore_reserved=false){
    //EVENT
    if ($this->active && !$this->sold_out){
        //we have an ective and not sold out event, now check sales and baskets, to see how many tickets ae stil available

    //get all tickets in baskets
